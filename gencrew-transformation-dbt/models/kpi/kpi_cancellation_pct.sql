...
select
        ...
        round(100.0 * COUNT(DISTINCT CASE WHEN f.status = 'CANCELLED' THEN f.reservation_id END) / nullif(COUNT(DISTINCT f.reservation_id), 0), 2) as cancellation_pct
